KWS = {
  ...
  "print" => ->(x : String, y : Int32) { _puts_ x },
  ...
  "*" => ->(x : String, y : Int32) { r = mul(x, y); return "",r },
  "/" => ->(x : String, y : Int32) { r = div(x, y); return "",r },
  ...
  "=" => ->(x : String, y : Int32) { let(x,y); return "",0 },
  ...
  "run" =>  ->(x : String, y : Int32) { Code.current_line = 0; Code.run (x); return "",0 },
